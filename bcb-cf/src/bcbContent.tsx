...
export const CONTENT: Record<Lang, Content> = {
  KO: {
    ...
    contact: {
      eyebrow: "테스터 신청",
      h2: (<>지금 당사의 데이터를 보내 <em>절약을 확인하세요.</em></>),
      lead: "실제 패킷 샘플을 보내주시면, 위 항목에서 BCB가 실제로 얼마나 줄여주는지 직접 측정해 회신드립니다. 민감정보는 임의 수치로 대체해 보내주세요.",
      fields: {
        company: "회사",
        useCase: "용도",
        useCaseOpts: [
        ...
        dataSample: "패킷 데이터 샘플",
        dataSampleHint: "실제 패킷 바이트(hex) 또는 구조 설명. 민감정보는 임의 수치로 대체해 주세요.",
      },
      ...
      success: "신청이 접수되었습니다. 영업일 기준 1~2일 내 측정 결과로 회신드리겠습니다.",
      altPrefix: "또는 ",
    },
    result: {
    ...
    apply: {
      title: (<>테스터 <em>신청</em></>),
      intro: "회사 이메일과 패킷 데이터 샘플을 남겨주세요. BCB 압축률을 실측해 영업일 기준 1~2일 내 회신드립니다.",
      note: "민감한 데이터는 비슷한 임의값으로 교체하여 보내주세요.",
      addLabel: "데이터 항목 추가",
      addBtn: "추가",
      valuePlaceholder: "값 또는 설명 (예: 0x1A2B / 12.5 / sensor_id=403)",
  ...
  EN: {
    ...
    contact: {
      eyebrow: "Become a tester",
      h2: (<>Send your data and <em>see the savings.</em></>),
      lead: "Send a real packet sample and we measure how much BCB cuts across the items above, then reply with the result. Replace any sensitive values with dummy numbers.",
      fields: {
        company: "Company",
        useCase: "Use case",
        useCaseOpts: [
        ...
        dataSample: "Packet data sample",
        dataSampleHint: "Raw packet bytes (hex) or a structure description. Replace sensitive values with dummy numbers.",
      },
      emailPlaceholder: "Work email",
      submit: "Apply as tester →",
      submitting: "Sending…",
      invalidEmail: "Please enter a valid email.",
      invalidNumbers: "Please enter avg packet size and packets per second.",
      success: "Your tester request is in. We'll reply with measured results within 1–2 business days.",
      altPrefix: "or ",
    },
    result: {
    ...
    footer: { rights: "BCB Labs · © 2026 Hoshi · Proprietary, all rights reserved" },
    apply: {
      title: (<>Become a <em>tester</em></>),
      intro: "Leave your work email and a packet data sample. We measure BCB's compression and reply within 1–2 business days.",
      note: "Please replace sensitive data with similar dummy values before sending.",
      addLabel: "Add a data item",
      addBtn: "Add",
      valuePlaceholder: "Value or description (e.g. 0x1A2B / 12.5 / sensor_id=403)",
